...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Student Admin', 'Admin']
  ...
  # config.excluded_models = ['Student', 'Task', 'Work']

  # Include specific models (exclude the others):
  # config.included_models = ['Student', 'Task', 'Work']
  ...
  #     configure :works, :has_many_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your work.rb model definition

  #   # Found associations:

  #     configure :task, :belongs_to_association 
